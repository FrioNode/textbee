package com.frionode.textbee.activities;
...
import com.frionode.textbee.activities.SMSFilterActivity;
...
import com.frionode.textbee.dtos.SimInfoCollectionDTO;
import com.frionode.textbee.helpers.SharedPreferenceHelper;
import com.frionode.textbee.helpers.VersionTracker;
import com.frionode.textbee.helpers.HeartbeatManager;
...
//        TextbeeUtils.startStickyNotificationService(mContext);
        ...
        scanQRBtn.setOnClickListener(view -> {
            ...
            intentIntegrator.setPrompt("Go to cloudtext.frionode.online/dashboard and click Register Device to generate QR Code");
        ...
        checkUpdatesBtn.setOnClickListener(view -> {
            ...
            String downloadUrl = "https://cloudtext.frionode.online/download?currentVersion=" + encodedVersionInfo;
        ...
        tryNewUIBtn.setOnClickListener(view -> {
            ...
            Intent intent = new Intent(MainActivity.this, com.frionode.textbee.ui.splash.SplashActivity.class);
